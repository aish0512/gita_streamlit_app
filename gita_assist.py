...
with st.container():
    ...
    with st.expander("Assistants Role"):
        st.write("""
        This assistant offers guidance on overcoming self-doubt and fear by tapping into our inner strength and connecting with our true nature using the knowledge of 'Bhagavad Gita'.
    """)
